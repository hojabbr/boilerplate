...
return [
    ...
    // Fallback when the languages table is empty. At boot, AppServiceProvider overwrites this
    // from the DB (SupportedLocalesService). Default locales for fresh install come from
    // LanguageSeeder::defaultLocales(); add languages via Filament "Add language" or boilerplate:locale.
    'supportedLocales' => [
