...
A **production-ready starter** for **Laravel 12**, **Inertia 2**, and **React 19** with localization, feature flags, dynamic XML sitemap, full-text search, Filament admin, and real-time support. Use it as a template or clone to build full-stack apps without redoing auth, i18n, theme, or tooling.
...
- **[Features](features.md)** — Localization, feature flags, search, sitemap, and the Filament admin panel.
...
| Features        | [Localization](localization.md), [Feature flags](feature-flags.md), [Search](search.md), [Sitemap](sitemap.md), [Admin](admin.md) |
