...
import PasswordController from '@/actions/App/Domains/Profile/Http/Controllers/PasswordController';
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <h1 className="sr-only">
                {t['settings.password_heading'] ?? 'Password Settings'}
            </h1>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <Heading
                        variant="small"
                        title={
                            t['settings.password_update_title'] ??
                            'Update password'
                        }
                        description={
                            t['settings.password_update_description'] ??
