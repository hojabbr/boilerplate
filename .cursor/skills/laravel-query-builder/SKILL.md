...
This package lets you build Eloquent queries from API request parameters that follow a convention similar to the JSON API specification. [oai_citation:1‡Spatie](https://spatie.be/docs/laravel-query-builder/v6/introduction)
